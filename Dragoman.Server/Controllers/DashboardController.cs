...
public class DashboardController : ControllerBase
{
    ...
    [HttpGet("audiences/detail-today")]
    public async Task<IActionResult> GetAudiencesDetailToday(CancellationToken ct)
    {
        var data = await _db.VAudienceInterpreteDetail
            .AsNoTracking()
            .ToListAsync(ct);
